...
class Game(arcade.Window):
    ...
    def on_update(self, delta_time):
        ...
        Δx_a = self.snake.center_x - self.apple.center_x
        Δy_a = self.snake.center_y - self.apple.center_y
        Δx_p = self.snake.center_x - self.pear.center_x
        Δy_p = self.snake.center_y - self.pear.center_y
